...
router.post("/insert_address/:id/",middlewareController.verifyTokenAndUserAuthorization,userController.insert_address)
router.post("/delete_address/:id/:Address_id/",middlewareController.verifyTokenAndUserAuthorization,userController.delete_address)
router.post("/update_address/:id/:address_id/",middlewareController.verifyTokenAndUserAuthorization,userController.update_address)
